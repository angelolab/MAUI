function mask = MIBI_get_mask_graded(rawMaskData,cap,t,gausRad,plot,titletext,reuseFigure)
...
rawMaskData = imtranslatetrail(rawMaskData,pipeline_data.points.offset);
