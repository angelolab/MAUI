...
dataobj.str.data_menu = uicontrol(dataobj.str.uifig, 'style', 'popupmenu', 'string', dataobj.str.labels, 'units', 'normalized', 'position', [.1, 1-.5, .9, .1], 'value', 1, 'callback', @data_menu_callback);
dataobj.str.view_menu = uicontrol(dataobj.str.uifig, 'style', 'popupmenu', 'string', dataobj.str.labels, 'units', 'normalized', 'position', [.1, 1-.6, .9, .1], 'value', 1, 'callback', @view_menu_callback);

dataobj.str.point_text = uicontrol(dataobj.str.uifig, 'style', 'text', 'string', 'Point', 'units', 'normalized', 'position', [0, 1-.4, .1, .1]);
dataobj.str.data_text = uicontrol(dataobj.str.uifig, 'style', 'text', 'string', 'Data', 'units', 'normalized', 'position', [0, 1-.5, .1, .1]);
dataobj.str.view_text = uicontrol(dataobj.str.uifig, 'style', 'text', 'string', 'View', 'units', 'normalized', 'position', [0, 1-.6, .1, .1]);
