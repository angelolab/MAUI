function varargout = mibitracker_gui(varargin)
% MIBITRACKER_GUI MATLAB code for mibitracker_gui.fig
%      MIBITRACKER_GUI, by itself, creates a new MIBITRACKER_GUI or raises the existing
%      singleton*.
%
%      H = MIBITRACKER_GUI returns the handle to a new MIBITRACKER_GUI or the handle to
%      the existing singleton*.
%
%      MIBITRACKER_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MIBITRACKER_GUI.M with the given input arguments.
%
%      MIBITRACKER_GUI('Property','Value',...) creates a new MIBITRACKER_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mibitracker_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mibitracker_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mibitracker_gui

% Last Modified by GUIDE v2.5 20-Dec-2018 15:32:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mibitracker_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @mibitracker_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mibitracker_gui is made visible.
function mibitracker_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mibitracker_gui (see VARARGIN)

% Choose default command line output for mibitracker_gui
...
% UIWAIT makes mibitracker_gui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = mibitracker_gui_OutputFcn(hObject, eventdata, handles) 
